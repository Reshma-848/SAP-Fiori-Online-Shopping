...
view YC_FashionType as select from Fashion_Types as fType {
    fType.id as fashionTypeID @(title: 'Fashion Type ID'),
    fType.typename as fashionTypeName @(title: 'Fashion Type Name'),
    fType.section.name as sectionName @(title: 'Section Name')
};
